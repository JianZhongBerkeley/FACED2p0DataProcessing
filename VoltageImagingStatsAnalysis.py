...
def voltage_imaging_stats_analysis(
    ...
    cur_spike_event = roi_spike_events[roi_idx, :, :]
    cur_subthreshold_dFF = roi_subthd_dFFs[roi_idx, :, :]
...
if __name__ == "__main__":
    ...
    t_test_pass, anova_test_pass, fr_OSI, subthd_OSI, _, _ = voltage_imaging_stats_analysis(
        demo_src_file_path,
        0,
        0.05,
        0.05,
